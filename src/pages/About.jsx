        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="relative h-[600px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4">
                    <div className="overflow-hidden">
                        <h1 className="text-6xl md:text-8xl font-extrabold text-white mb-6 tracking-tighter animate-reveal">
                            Our Story
                        </h1>
                    </div>
                    <p className="text-xl md:text-2xl text-amber-300 font-medium max-w-3xl mx-auto animate-fade-in-up animation-delay-500 opacity-0 fill-mode-forwards">
            ...
            <div className="max-w-7xl mx-auto px-4 py-32">
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                    <div className="animate-slide-in-right opacity-0 fill-mode-forwards">
                        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 border-l-8 border-amber-500 pl-8 leading-tight">
                        ...
                        <div className="p-8 bg-amber-50 rounded-2xl border-l-4 border-amber-500 animate-fade-in-up animation-delay-500 opacity-0 fill-mode-forwards">
                            <p className="text-lg text-amber-900 leading-relaxed italic font-medium">
                    ...
                    <div className="relative group">
                        <div className="absolute -top-10 -left-10 w-80 h-80 bg-amber-200 rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob"></div>
                        <div className="absolute -bottom-10 -right-10 w-80 h-80 bg-gray-300 rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob animation-delay-2000"></div>
                        <div className="relative bg-white/60 backdrop-blur-xl p-12 rounded-3xl border border-white/50 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] hover:shadow-[0_32px_64px_-16px_rgba(251,191,36,0.2)] transition-all duration-700">
                            ...
                            <ul className="space-y-6">
                                {[
                                    ...
                                    { icon: <Stars className="text-amber-600" />, text: 'Guaranteed authenticity', delay: 'animation-delay-1000' },
                                    { icon: <Public className="text-amber-600" />, text: 'Global logistics network', delay: 'animation-delay-500' },
                                    { icon: <SupportAgent className="text-amber-600" />, text: 'Dedicated concierge support', delay: 'animation-delay-1000' }
                                ].map((item, i) => (
            ...
            <div className="bg-gray-50 py-32 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10">
                    <div className="text-center mb-20 animate-fade-in-up opacity-0 fill-mode-forwards">
                    ...
                    <div className="grid md:grid-cols-3 gap-10">
                        {[
                            ...
                            <div key={idx} className={`group bg-white p-10 rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:-translate-y-2 animate-fade-in-up opacity-0 fill-mode-forwards ${item.delay}`}>
